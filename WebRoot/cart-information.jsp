		...
		<div id="s_hdw">
			...
			<div class="mmenu">
				<div class="s_hd">
					...
					<div id="s_cart">
						<ul>
							<li class="nums"><a href="cart.jsp" id="s_cart_nums1">购物车：
									<span><%=c.productcount()%></span> 件
								...
								<form action="cart-information.jsp" method="get">
									<table class="address" width="100%">
										...
										<tr>
											...
											<td><input type="text" name="phone" value="如18888888888"
										...
										<tr>
											<td colspan="2"><input type="submit" value="确认收货信息"
												class="btntext" /></td>
										</tr>
										<%
											}else{
										%>
										<tr>
											<td colspan="2"><span class="red">*</span>保存成功</td>
										</tr>
										<%
											}
										%>
						...
						<tr>
							...
							<td class="summary">
								<table class="catlist" width="100%">
									...
									%>
									<tr>
										<td><a href="#"><%=item.getName()%></a><br />商品编号：<%=item.getProductid()%></td>
