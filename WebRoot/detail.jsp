...
<div id="doc">
	<div id="s_hdw">
		...
		<div id="s_tbar">
			<div class="s_hd">
				<div class="tbar_lft">您好，欢迎来到学友淘！<a href="#">请登录</a> | <a href="#">免费注册</a></div>
				<div class="tbar_rgt">
					<ul>
						<li class="first"><a href="#">我的订单</a></li>
						<li><a href="#">我的学友淘</a></li>
						<li><a href="#">购物车</a></li>
						<li><a href="#">收藏夹</a></li>
						<li><a href="#"><li><a href="/LOGO/admin/login.jsp">进入后台</a></li>
		...
		<div class="s_hd nav">
			<div id="s_logo"><a href="index.jsp"><img src="images/logo.jpg" border="0" /></a></div>
			<div id="s_nav">
				<ul>
		...
		<div class="mmenu">
			<div class="s_hd">
				...
				<div id="s_cats">
					<div class="cat_hd"><h3><a style="color:#FFFFFF" >所有商品分类</a></h3></div>
					<div class="cat_bd">
					<ul>
					<li class="cat_item">
						...
						<div class="cat_cont_rgt">
							...
							<dl>
								...
								<dd>
									<ul>
										<li><a href="#">加入学友淘店铺</a></li>
										<li><a href="#">大学生开店</a></li>
										<li><a href="#">寒暑假招聘</a></li>
									</ul>
								</dd>
							</dl>
						</div>
				...
				<li class="cat_item">
					...
					<dd></dd></dl></div><div class="cat_cont_rgt"><dl><dt>猜你喜欢</dt><dd><ul><li><a href="#">洁云</a></li><li><a href="#">乐扣乐扣</a></li><li><a href="#">金纺</a></li><li><a href="#">ASD 爱仕达</a></li><li><a href="#">蓝月亮</a></li><li><a href="#">滴露</a></li><li><a href="#">可爱可</a></li><li><a href="#">SIMELO</a></li><li><a href="#">清风</a></li><li><a href="#">Supor 苏泊尔</a></li><li><a href="#">妙洁</a></li><li><a href="#">奥妙</a></li></dd></dl><dl><dt>促销专题</dt><dd><ul><li><a href="#">白猫满38元送漂水</a></li><li><a href="#">厨房清洁全攻略</a></li><li><a href="#">洁云赠品大放送</a></li><li><a href="#">一次性用品抄底价</a></li></dd></dl> </div> </div></li>
					...
					<li><a href="#">车载用品</a></li>
					</ul></dd></dl></div><div class="cat_cont_rgt"><dl><dt>猜你喜欢</dt><dd><ul><li><a href="#">诺基亚</a></li><li><a href="#">佳能</a></li><li><a href="#">三星</a></li><li><a href="#">尼康</a></li><li><a href="#">HTC</a></li><li><a href="#">索尼</a></li><li><a href="#">Apple 苹果</a></li><li><a href="#">硕美科</a></li><li><a href="#">漫步者</a></li><li><a href="#">卡西欧</a></li><li><a href="#">铁三角</a></li><li><a href="#">爱国者</a></li></dd></dl><dl><dt>促销专题</dt><dd><ul><li><a href="#">三星、摩托罗拉手机专</a></li><li><a href="#">“清仓价”电纸书大放</a></li><li><a href="#">单反镜头随心配，搭出</a></li><li><a href="#">数码相机，跳楼价清仓</a></li></dd></dl> </div> </div></li>
					...
					<li><a href="#">墙面开关</a></li>
					</ul></dd></dl></div><div class="cat_cont_rgt"><dl><dt>猜你喜欢</dt><dd><ul><li><a href="#">飞利浦</a></li><li><a href="#">松下</a></li><li><a href="#">索尼</a></li><li><a href="#">夏普</a></li><li><a href="#">创维</a></li><li><a href="#">海尔</a></li><li><a href="#">海信</a></li><li><a href="#">TCL</a></li><li><a href="#">Midea美的</a></li><li><a href="#">Supor 苏泊尔</a></li><li><a href="#">格兰仕</a></li><li><a href="#">博朗</a></li><li><a href="#">九阳</a></li></dd></dl><dl><dt>促销专题</dt><dd><ul><li><a href="#">三大合资空调疯狂抢购</a></li><li><a href="#">冰洗直降，步步惊喜！</a></li><li><a href="#">液晶电视清仓大放价，</a></li><li><a href="#">小家电惠战十月，最低</a></li></dd></dl> </div> </div></li>
					...
					<dd></dd></dl></div><div class="cat_cont_rgt"><dl><dt>猜你喜欢</dt><dd><ul><li><a href="#">苹果</a></li><li><a href="#">索尼</a></li><li><a href="#">SAMSUNG 三星</a></li><li><a href="#">联想</a></li><li><a href="#">ThinkPad</a></li><li><a href="#">华硕</a></li><li><a href="#">纽曼</a></li><li><a href="#">金士顿</a></li><li><a href="#">得力</a></li><li><a href="#">易达</a></li><li><a href="#">惠普</a></li><li><a href="#">智高</a></li></dd></dl> </div> </div></li>
					...
					<dd></dd></dl></div><div class="cat_cont_rgt"><dl><dt>猜你喜欢</dt><dd><ul><li><a href="#">小绵羊</a></li><li><a href="#">天堂伞</a></li><li><a href="#">空间大师</a></li><li><a href="#">大豪赛鲸</a></li><li><a href="#">外交官</a></li><li><a href="#">格雷特</a></li><li><a href="#">七匹狼</a></li><li><a href="#">瑞士军刀威戈Wenger</a></li><li><a href="#">红海棠</a></li><li><a href="#">洁丽雅</a></li><li><a href="#">华润家纺</a></li><li><a href="#">御灵珠宝</a></li><li><a href="#">安美驰</a></li></dd></dl><dl><dt>促销专题</dt><dd><ul><li><a href="#">床品套件99元起</a></li><li><a href="#">华润家纺买赠特促</a></li><li><a href="#">御灵珠宝登入学友淘</a></li><li><a href="#">婚庆开始了</a></li></dd></dl> </div> </div></li>
					...
					<dd></dd></dl></div><div class="cat_cont_rgt"><dl><dt>猜你喜欢</dt><dd><ul><li><a href="#">皇室</a></li><li><a href="#">费雪</a></li><li><a href="#">乐高</a></li><li><a href="#">芭比</a></li><li><a href="#">孩之宝</a></li><li><a href="#">伊诗比蒂</a></li><li><a href="#">LALABABY</a></li><li><a href="#">蒲蒲兰绘本馆</a></li><li><a href="#">洪恩</a></li><li><a href="#">小企鹅</a></li><li><a href="#">乐乐趣</a></li><li><a href="#">毛毛仔</a></li></dd></dl><dl><dt>促销专题</dt><dd><ul><li><a href="#">300款玩具1折起售</a></li><li><a href="#">三大品牌遥控玩具特卖</a></li><li><a href="#">乐高超低价</a></li><li><a href="#">费雪 乐高 皇室联合让</a></li></dd></dl> </div> </div></li>
					...
					<dd></dd></dl></div><div class="cat_cont_rgt"><dl><dt>猜你喜欢</dt><dd><ul><li><a href="#">绿A</a></li><li><a href="#">喜瑞</a></li><li><a href="#">白兰氏</a></li><li><a href="#">养生堂</a></li><li><a href="#">奈氏力斯</a></li><li><a href="#">善存</a></li><li><a href="#">碧生源</a></li><li><a href="#">欧姆龙</a></li><li><a href="#">昂立</a></li><li><a href="#">恒寿堂</a></li><li><a href="#">lumi</a></li><li><a href="#">膳通</a></li><li><a href="#">修身堂</a></li></dd></dl><dl><dt>促销专题</dt><dd><ul><li><a href="#">保健品0利润抢购第二</a></li><li><a href="#">保健品滋补人气排行</a></li><li><a href="#">情趣用品系列</a></li><li><a href="#">雅姿饼干买3送1</a></li></dd></dl> </div> </div></li>
					</ul>
	...
	<div id="s_bdw">
		<div id="s_bd">
			...
			<div class="breadcrumbs">
				<div class="f-l"><a href="#">全部结果</a><span>»</span><a href="#">书籍</a><span>»</span><a href="#">编程</a><span>»</span>Java</div>
			</div>
			...
			<div class="detail cf">
				...
				<div class="f-r desummary">
					...
					<div class="dl01"><span class="f-l">学友淘价：<strong class="red"><%=p.getMemberprice() %></strong>元</span><a title="降价通知" class="downtip" href="#"></a><span class="f-l projf"> <a class="more" href="#"></a></span></div>
					<div class="dl02">市场价：<del><%=p.getNormalprice() %></del>元<br />提示：特价商品，不能使用优惠券</div>
					<div class="dl03">
					...
					<input type="hidden" name="id" value="<%=p.getId()%>"/>
						<div class="addnum">
							...
							<div class="f-l numinput">
                        		...
                        		<input type="text" name="count" value="1" id="qty_item_1" onKeyUp="setAmount.modify('#qty_item_1')" class="stext"/>
                        		<a class="add" onClick="setAmount.add('#qty_item_1')" href="javascript:void(0)"></a>
							</div>
							<span class="f-l">限购1件</span>
						</div>
						<div class="addbtn">
							<input type="submit" value="" id="" class="catbtnimg"/><span class="f-l"><a href="#">收藏</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#">价格举报</a></span>
						</div>
						</form>
					</div>
					
					<ul class="dl05">
						<li><span class="f-l tit">商品编号：</span><span class="f-l"><%=p.getId() %></span></li>
						<li><span class="f-l tit">描&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;术：</span><span class="f-l"><%=p.getDescription() %></span></li>
					...
					<div class="dl06">
						<dl class="hg"><dt></dt><dd>本产品支持二手交易，二手换购，当您不需要再使用可以回到这里与他人交换书籍窝~</dd></dl>
						<div class="hgscrollbox">
							<a title="左移" href="#left" class="abtn aleft agrayleft"></a>
							<div class="hgscrollpic">
								<ul>
									<li>
										<a href="#"><img src="images/hg01.jpg" width="115" height="115" alt="" /></a>
										<dl>
											<dt><a href="#">C语言从入门到精通..</a></dt>
											<dd><del>￥23.8</del></dd>
									...
									<li>
										<a href="#"><img src="images/hg02.jpg" width="115" height="115" alt="" /></a>
										<dl>
											<dt><a href="#">java编程思想第4版中..</a></dt>
											<dd><del>￥23.8</del></dd>
											<dd><strong>数量:<span class="red">1</span>个</strong></dd>
											<dd><strong class="red">换购价：￥9.9</strong></dd>
											<dd><a class="ljbtn" href="#"></a></dd>
									...
									<li>
										<a href="#"><img src="images/hg03.jpg" width="115" height="115" alt="" /></a>
										<dl>
											<dt><a href="#">Java Web从入门到..</a></dt>
											<dd><del>￥23.8</del></dd>
											<dd><strong>数量:<span class="red">1</span>个</strong></dd>
											<dd><strong class="red">换购价：￥9.9</strong></dd>
											<dd><a class="ljbtn" href="#"></a></dd>
				...
				<div class="dtsummary">
					<dl>
						...
						<dd>
							<ul class="dtpro cf">
								<li>商品名称：Java从入门到精通(第3版)</li>
								<li>品牌：明日科技</li>
								<li>作者地区: 中国大陆</li>
								<li>ISBN编号: 9787302287568</li>
								<li>出版时间: 2012年09月</li>
							</ul>
							<div class="dtprodis">
							...
							<div class="dtbq">
								<h3>品牌介绍</h3>
								<p>该商品参与了公益宝贝计划，卖家承诺每笔成交将为贫困顶梁柱重病救助行动捐赠0.02元。该商品已累积捐赠60492笔。</p>
							</div>
							<div class="dtbq">
								<h3>服务承诺：</h3>
								<p>该商品参与了公益宝贝计划，卖家承诺每笔成交将为贫困顶梁柱重病救助行动捐赠0.02元。该商品已累积捐赠60492笔。</p>
					...
					<dl>
						...
						<dd class="discusstabcon">
							<div class="discussnum cf">
								...
								<div class="f-l pl5">前5位评论用户：我***哥,挽***底,e***言,慕***嵬,狙***9</div>
								<div class="f-r plbtn">
									<span>我在学友淘买过此产品</span>
							...
							<div class="discusslist">
								<ul>
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="images/qzx.gif" width="48" height="48" alt="" /></a><span>我***哥（匿名）</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">11.17</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：书不错，是正版，物流也很快，五星好评。但强烈建议进阶程序猿不用买这本书，入门是可以的，适合零基础阅读，但是要精通光看这本书就有点难了</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="images/qzx.gif" width="48" height="48" alt="" /></a><span>舞***慕（匿名）</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">今天</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：书不错！挺全，附带小白手册和光盘，双十一物流量大快递来的稍晚一些，不过阻止不了我热爱学习的热情！随便附俩张照片！</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="images/qzx.gif" width="48" height="48" alt="" /></a><span>白***a（匿名）</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">09.23</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：宝贝送的很快，包装完整精美，是正版，还有配套光盘和小白手册，很适合初学者学习！</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="images/qzx.gif" width="48" height="48" alt="" /></a><span>h***k（匿名）</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">10.06</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：正版全新书，无破损，价格实惠，推荐购买。</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
								</ul>
							</div>
							...
							<div class="discusslist">
								<ul>
									<li class="cf">
										...
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">11.17</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：入门是可以的，适合零基础阅读</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="images/qzx.gif" width="48" height="48" alt="" /></a><span>舞***慕（匿名）</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">今天</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：也就买来看看的</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="images/qzx.gif" width="48" height="48" alt="" /></a><span>白***a（匿名）</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">09.23</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：很适合初学者学习！</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="images/qzx.gif" width="48" height="48" alt="" /></a><span>h***k（匿名）</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">10.06</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：一般般吧。</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
								</ul>
							</div>
							...
							<div class="discusslist">
								<ul>
									<li class="cf">
										...
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">11.17</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：这书太难用</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="images/qzx.gif" width="48" height="48" alt="" /></a><span>舞***慕（匿名）</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">今天</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：学不懂，可以给个差评吗？</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="images/qzx.gif" width="48" height="48" alt="" /></a><span>白***a（匿名）</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">09.23</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：也就这样了，买了不会看的</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
									<li class="cf">
										<div class="f-l dislpic"><a href="#"><img src="images/qzx.gif" width="48" height="48" alt="" /></a><span>h***k（匿名）</span></div>
										<div class="f-l disrdis">
											<div class="disdate"><span class="f-l">10.06</span><span class="f-l">评论</span><span class="starpoint"></span></div>
											<div class="disinfo"><span class="f-l">评论：书是好的，但是学不进去。</span><div class="f-r withme"><span class="f-l">这个评论对我</span><a href="#">有用 <b class="red">0</b></a><a href="#">没用 <b class="red">0</b></a></div>
										</div>
									</li>
								</ul>
							</div>
		...
		<div class="ft_quicklinks">
			...
			<div id="s_ft">
				<div class="ft_suggest pt100">
					<div class="ft_suggest pt100">友情链接：<a href="http://www.hnsoftedu.com/">湖南软件职业技术学院</a></div>
				</div>
				<div class="copyright tac pbt10">版权所有 Copyright&copy; 学友淘 All
