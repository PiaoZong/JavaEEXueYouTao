<%@page import="com.syc.shopping.PassNotRightException"%>
<%@page import="com.syc.shopping.UserNotFountException"%>
...
<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	if (action != null && action.equals("login")) {
		...
		try {
			u = user.userExist(username, password);
		} catch (UserNotFountException e) {
			out.println("用户名不存在");
			return;
		} catch (PassNotRightException e) {
			out.println("学友淘友情提醒：亲~您输入的密码错误，请重新输入");
			return;
		}
					...
					<input type="hidden" name="action" value="login"></input>
						...
						<div class="form" style="width:600px;">
							...
							<div class="item">
								...
								<div class="fl">
									<input type="password" id="loginpwd" name="pwd" class="text" tabindex="2"/>
						...
						<div id="guide">
							...
							<div class="content">现在免费注册成为学友淘用户，便能立刻享受便宜又放心的购物乐趣。【内部账号：用户名：测试账号 密码：123456】</div>
