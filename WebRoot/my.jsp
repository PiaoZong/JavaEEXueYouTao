...
<div id="doc">
	<div id="s_hdw">
		...
		<div id="s_tbar">
			<div class="s_hd">
				<div class="tbar_lft">您好，欢迎来到学友淘！
				<%if(u==null){ %>
				<a href="login.jsp">请登录</a> | <a href="register.jsp">免费注册</a></div>
				<%}else{ %>
				HI,用户<%=u.getUsername() %>
				<%} %>
				</div>
	...
	<div id="s_bdw">
		<div id="s_bd">
			...
			<div class="breadcrumbs">
				<div class="f-l"><a href="#">首页</a><span>»</span><a href="#">我的学友淘</a><span>»</span>我的订单</div>
			</div>
						...
						<dd>
							<div class="ddtable">
								<table class="ddinfo" width="100%">
									...
									<tr>
										<td width="100px"><a class="blue" href="#">20171118</a></td><td width="240px"><a href="#"><img src="images/124ad.jpg" width="58" height="58" alt="" /></a><a href="#"><img src="images/124ad.jpg" width="58" height="58" alt="" /></a><a href="#"><img src="images/124ad.jpg" width="58" height="58" alt="" /></a></td><td>嫖总</td><td>2017-11-18</td><td>￥47.40<br />(支付宝)</td><td class="ddgz">待支付<br /><a class="gzbtn blue" href="javascript:void(0);">跟踪</a>
										<div class="ddtipbox">
											...
											<div>
												...
												<table width="100%">
													...
													<tr>
														<td>2017-11-17 16:28:02</td><td>您提交了订单，等到客服审核。</td>
													</tr>
													<tr>
														<td>2017-11-17 16:28:02</td><td>您提交了订单，等到客服审核。</td>
													</tr>
