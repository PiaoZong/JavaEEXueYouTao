...
products=productManager.getInstance().getrecentproducts(4);
%>
<head>
		...
		<div id="s_hdw">
			...
			<div class="mmenu">
				<div class="s_hd">
					...
					<div id="s_cart">
						<ul>
							<li class="nums"><a href="cart.jsp" id="s_cart_nums1">购物车： <span><%if(session.getAttribute("cart")!=null){
								cart c=(cart)session.getAttribute("cart");
								out.println(c.productcount()); %></span>
							<% }else{
								out.println(0);
							}%>
									件
					...
					<div id="s_cats">
						...
						<div class="cat_bd" style="display:block;">
							<ul>
								<li class="cat_item">
									<h4 class="cat_tit">
										<a href="#" class="cat_tit_link">食品、饮料、酒水</a><span
											class="s_arrow">></span>
									</h4>
									<div class="cat_cont">
								...
								<li class="cat_item">
									<h4 class="cat_tit">
										<a href="#" class="cat_tit_link">美容化妆、个人护理</a><span
											class="s_arrow">></span>
									</h4>
									<div class="cat_cont">
										<div class="cat_cont_lft">
								...
								<li class="cat_item">
									<h4 class="cat_tit">
										<a href="#" class="cat_tit_link">母婴食品、母婴用品</a><span
											class="s_arrow">></span>
									</h4>
									<div class="cat_cont">
										<div class="cat_cont_lft">
								...
								<li class="cat_item">
									<h4 class="cat_tit">
										<a href="#" class="cat_tit_link">厨房用品、清洁用品</a><span
											class="s_arrow">></span>
									</h4>
									<div class="cat_cont">
										<div class="cat_cont_lft">
								...
								<li class="cat_item"><h4 class="cat_tit">
										<a href="#" class="cat_tit_link">手机通讯、数码电器</a><span
											class="s_arrow">></span>
									</h4>
									<div class="cat_cont">
										<div class="cat_cont_lft">
								...
								<li class="cat_item"><h4 class="cat_tit">
										<a href="#" class="cat_tit_link">大家电、生活电器</a><span
											class="s_arrow">></span>
									</h4>
									<div class="cat_cont">
										<div class="cat_cont_lft">
								...
								<li class="cat_item"><h4 class="cat_tit">
										<a href="#" class="cat_tit_link">电脑,软件,办公用品</a><span
											class="s_arrow">></span>
									</h4>
									<div class="cat_cont">
										<div class="cat_cont_lft">
								...
								<li class="cat_item"><h4 class="cat_tit">
										<a href="#" class="cat_tit_link">家居汽饰、箱包运动</a><span
											class="s_arrow">></span>
									</h4>
									<div class="cat_cont">
										<div class="cat_cont_lft">
								...
								<li class="cat_item"><h4 class="cat_tit">
										<a href="#" class="cat_tit_link">玩具、图书音像</a><span
											class="s_arrow">></span>
									</h4>
									<div class="cat_cont">
										<div class="cat_cont_lft">
								...
								<li class="cat_item"><h4 class="cat_tit">
										<a href="#" class="cat_tit_link">服装鞋帽</a><span class="s_arrow">></span>
									</h4>
									<div class="cat_cont">
										<div class="cat_cont_lft">
											<dl class="cf">
								...
								<li class="cat_item"><h4 class="cat_tit">
										<a href="#" class="cat_tit_link">营养保健、健康器械</a><span
											class="s_arrow">></span>
									</h4>
									<div class="cat_cont">
										<div class="cat_cont_lft">
						...
						<div class="i_col_rgt_box">
							...
							<div class="rgt">
								<div class="rgt-box">
									<div class="loginbox">
										<div class="pic">
											<a href="#"><img src="images/dlt.png" border="0" /></a>
										</div>
										...
										<div class="announce_top cf">
											<h3>
												关于学友淘<span><a href="#">更多</a></span>
											</h3>
										</div>

										<div class="announce_cont">
											<ul>
												<li><a href="#">这是一份来自火星的信息~</a></li>
												<li><a href="#">欢迎你来到学友淘网上商城</a></li>
												<li><a href="#">服务宗旨：以人为本</a></li>
												<li><a href="#">选择我们；绝对没错</a></li>
											</ul>
										</div>
									</div>
								</div>
				...
				<div class="cf">
					...
					<div class="i_col_rgt">
						<div class="i_col_rgt_box1">
							<div class="lft">
								<div class="i_qg">
									<dl id="slide-qg">
										<dt class="cf">
											<a href="javascript:void(0);">有好货</a> 
											...
											<div class="cat_list_box slide_cont">
												<ul>
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg1-1.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">菲拉格慕混纺水彩画印</a>
															</div>
													...
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg1-2.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">丹麦Ecco休闲鞋</a>
															</div>
													...
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg1-3.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">Urban Outfitters美式破</a>
															</div>
															<div class="sprice">
																特价：<span>¥1598<span>
															</div>
													...
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg1-4.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">AJ限量款休闲鞋</a>
															</div>
											...
											<div class="cat_list_box slide_cont">
												<ul>
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg2-1.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">INXX拼接抓绒卫衣</a>
															</div>
													...
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg2-2.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">红袖 刺绣印花白衬衫</a>
															</div>
													...
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg2-3.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">SK-II护肤精华露</a>
															</div>
													...
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg2-4.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">uniform experiment 双层衬衫</a>
															</div>
															<div class="sprice">
																特价：<span>¥12.8<span>
															</div>
											...
											<div class="cat_list_box slide_cont">
												<ul>
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg3-1.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">Miss Sixty不规则半身长</a>
															</div>
															<div class="sprice">
																特价：<span>¥3.6</span>
															</div>
													...
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg3-2.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">L'OREAL欧莱雅清润全日保湿水精华凝露 </a>
															</div>
															<div class="sprice">
																特价：<span>¥90</span>
															</div>
													...
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg3-3.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">意大利威化夹心饼干</a>
															</div>
													...
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="#"><img src="images/qg3-4.jpg" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="#">韩恩眼线笔防水防汗不脱色</a>
															</div>
															<div class="sprice">
																特价：<span>¥99<span>
															</div>
										...
										<dd>
											...
											%>
													<li>
														<div class="cat_pd">
															<div class="pic">
																<a href="detail.jsp?id=<%=p.getId()%>"><img src="<%=request.getContextPath()+"/admin/upload/"+p.getImadress() %>" border="0" /></a>
															</div>
															<div class="ptitle">
																<a href="detail.jsp?id=<%=p.getId()%>"><%=p.getName()%></a>
															</div>
															<div class="sprice"> 特价：<span>¥<%=p.getMemberprice() %></span>
															</div>
														</div>
													</li>
												</ul>
						...
						<div class="rgt">
							<div class="rgt-box">
								<div class="i_tg">
									<div class="i_tg_top cf">
										<h3>
											公告栏<span><a href="#">更多</a></span>
										</h3>
									</div>
									<div class="i_tg_cont">
										<h4>
											<a href="#">学友淘是为校园购物而诞生的购物网站，是一个能为学生节省开销，买到更好的更实用的东西的网上商城!!</a>
										</h4>
										<div class="i_tg_pic">
