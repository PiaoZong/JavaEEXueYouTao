...
<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	if (action != null && action.equals("register")) {
		...
		u.setMail(mail);
		u.setRdata(new Timestamp(System.currentTimeMillis()));
		u.save();
		out.println("注册成功！");
		out.println("<a href='login.jsp'><h2>登陆</h2></a>");
		return;
	}
%>
	...
	<div id="s_bdw">
		<div id="s_bd">
			...
			<div class="dl_zc">
					...
					<input type="hidden" name="action" value="register"/>
						<div class="form">
							...
							<div class="item">
								...
								<div class="fl">
									<input type="text" name="mail" class="text" tabindex="4" onfoucs/>
							...
							<div class="item">
								...
								<div class="fl">
									<input type="text" name="username" class="text" id="uname" onblur="validate()"/>
							...
							<div class="item">
								...
								<input type="submit" class="btnimg" id="registsubmit" value=""
									   tabindex="8"/>
							</div>
							<!--item end-->
				...
				var request;
				function validate(){
					var zhi=document.getElementById("uname");
					var url="validate.jsp?username="+escape(zhi.value);//转码
					...
					*/
					...
					request.onreadystatechange=callback;//回调函数
					request.send(null);
				}
				...
				function setMsg(msg){
					mdiv = document.getElementById("username_error");
					if(msg == "true") {
						mdiv.innerHTML = "<font color='red'>该用户已被注册</font>";
					} else {
						mdiv.innerHTML = "<font color='green'>可以注册</font>";
					}
				}
				</script>
